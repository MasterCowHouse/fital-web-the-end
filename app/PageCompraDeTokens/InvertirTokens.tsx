        ...
        <Box>
            <Box sx={{
                ...
                <Typography sx={{
                    ...
                    <br />
                    <span style={{color: '#26D3CA',}}>asegurar tu patrimonio con rendimientos.</span>
                </Typography>
                {/* //Modal */}
                <Button onClick={handleOpen} className="normal-case" sx={{
            ...
            <Box className={styles.container} sx={{
                ...
                <Box className={styles.textoTres} sx={{
                    ...
                    <Typography sx={{
                        ...
                        <br />
                        <br />
                        <span style={{fontWeight: 900}}>¡Algunos inmuebles <br />duran pocos minutos!</span>
                    </Typography>
                </Box>
