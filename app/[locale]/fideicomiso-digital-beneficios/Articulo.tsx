    ...
    >
      ...
      >
        ...
        <Box>
          ...
          >
            La{" "}
            <span style={{ color: "#FFC72C" }}>evolución del Fideicomiso</span>
            <br />
        ...
        >
          ...
          >
            ...
            >
              ¿Qué es un fideicomiso digital y sus beneficios para inmuebles?
            </span>
            <br />
            <br />
            ...
            <br />
            <br />
            <span style={{ color: "#524092" }}>2. Gestión Remota:</span> Permite
            ...
            Todas las transacciones son auditables y
            <br />
            visibles en tiempo real.
            <br />
            <br />
            <span style={{ color: "#524092" }}>
              En FITAL nos aseguramos de proteger tu patrimonio y hacer que
              <br />
              tus reglas se cumplan, contamos con una plataforma llamada{" "}
            </span>
            <br />
            <span style={{ color: "#524092", fontWeight: 900 }}>
              Imperio donde administras tus bienes y asignas beneficiarios
              <br />
              según tus reglas.{" "}
            </span>
            <br />
            <span style={{ color: "#524092", fontWeight: 900 }}>
              Entra ahora y comienza a ser parte de la revolución tecnológica.
            </span>
          </Typography>
        </Box>
      </Box>
