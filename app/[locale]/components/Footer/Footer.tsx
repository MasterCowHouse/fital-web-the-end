  ...
  const customBtnFooter: CustomBtnFooter[] = [
    {
      ...
      texto: t.raw("buttons")[0],
    },
    {
      id: 2,
      hrefFooterUno: "/PageFideicomiso",
      texto: t.raw("buttons")[1],
    },
    {
      id: 3,
      hrefFooterUno: "/PageWallet",
      texto: t.raw("buttons")[2],
    },
  ];
  return (
    <Box
    ...
    >
      ...
      >
        ...
        >
          ...
          >
            <Typography>{t("subscribe.title")}</Typography>
          </Box>
          <Box
            sx={{
              textAlign: {
          ...
          >
            <Typography>{t("subscribe.description")}</Typography>
          </Box>
          <Box
            sx={{
              padding: "20px 0px",
