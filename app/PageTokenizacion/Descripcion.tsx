            ...
            <Box sx={{
                ...
                <Box sx={{
                    ...
                    <Typography sx={{
                        ...
                        <br />
                        propiedades sean divididas en fracciones más pequeñas, facilitando la entrada en el mercado
                        <br />
                        inmobiliario con menos complicaciones. Además, al alojarse en una wallet el blockchain
                        <br />
