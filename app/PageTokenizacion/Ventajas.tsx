...
const customIconosVentajas: CustomIconosVentajas[] = [
  {
    ...
    texto: (
      <span>
        ...
        <br /> inmuebles físicos en tokens <br />
        (activos virtuales) que pueden comprarse
        <br /> y venderse fácilmente en mercados
        <br /> secundarios, lo que mejora la liquidez y<br /> facilita convertir
        las ganancias en efectivo.
      </span>
    ),
  },
  {
