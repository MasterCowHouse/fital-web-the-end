  ...
  return (
    ...
    >
      <Box>
        ...
        >
          <span style={{ color: "#26D3CA" }}>Mundo físico</span> en paralelo con{" "}
          <span style={{ color: "#FFC72C" }}>Mundo virtual</span>
        </Typography>
      </Box>
      ...
      >
        ...
        >
          ...
          >
            <span style={{ color: "#FFC72C" }}>RECOLECCIÓN DE DATOS</span>
            <br />
          ...
          >
            ...
            <br />
            respaldar el token (activo virtual).
          </Typography>
          <Typography
            sx={{
              marginBottom: "50px",
          ...
          <Typography>
            ...
            <br />
            venta de los tokens (activos virtuales) se
            <br />
