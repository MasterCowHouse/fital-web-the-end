...
const Footerlogos = () => {
  ...
  return (
    ...
    >
            ...
            <Box sx={style}>
              ...
              >
                ...
                >
                  ...
                  acceso a nuestra página web donde FITAL le hace saber a usted
                  que expresamente acepta dicha autorización para que la
                  información que se recabe al ingresar a nuestro portal, siendo
                  así de vital importancia la atención a sus datos sin que estos
                  sean vulnerados brindara un manejo adecuado de los mismos,
                  proporcionando seguridad y protección cumpliendo la finalidad
                  para la cual fueron recabados, sin promover la discriminación,
                  racismo, o alguna otra distinción malintencionada que ponga en
                  peligro la integridad de los involucrados, haciendo valer sus
                  derechos únicos e inviolables de cada uno.
                  <br />
                  FITAL MX se reserva el derecho de actualizar la presente
                  Política de privacidad en cualquier momento mediante la
                  publicación de una versión revisada en LOS SITIOS. La versión
                  revisada entrará en vigor en el momento de su publicación.
                  Además, si la versión revisada incluye un cambio sustancial,
                  se lo notificaremos con razonable anticipación publicando una
                  notificación en LOS SITIOS. Después de este período de
                  notificación, se considerará que ha aceptado expresamente
                  todas las modificaciones a esta política. <br />
                  En caso de que ocurra una vulneración de seguridad en
                  cualquier fase del tratamiento de datos personales, FITAL MX
                  lo hará del conocimiento general, de manera inmediata en
                  nuestro sitio web o mediante notificación personal para que
                  las personas involucradas en la vulneración de sus datos
                  personales tomen las medidas correspondientes a fin de
                  resguardar sus derechos. <br />
      ...
      >
        <Typography>2024 &copy; Todos los derechos reservados</Typography>
      </Box>
    </Box>
  );
};
