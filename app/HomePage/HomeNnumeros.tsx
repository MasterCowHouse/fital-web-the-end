...
const customNumeros: CustomNumeros[] = [
  {
    ...
    titulo: (
      <span>
        Los compradores pueden adquirir <br />
        fracciones de múltiples <br />
        propiedades en lugar de concentrar <br />
        todo su capital en un solo inmueble, <br />
  ...
  },
  {
    ...
    titulo: (
      <span>
        Al usar blockchain y fideicomisos, <br />
        se eliminan muchos intermediarios <br />
        tradicionales, lo que reduce los <br />
  ...
  },
  {
    ...
    titulo: (
      <span>
        Los tokens (activos virtuales) se pueden
        <br />
        transferir fácilmente entre compradores y <br />
        vendedores sin la necesidad de <br />
