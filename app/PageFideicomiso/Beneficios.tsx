...
const customBeneficios: CustomBeneficios[] = [
    ...
    },
    {
        ...
        texto: <span>Registro inmutable de <br />transacciones con tecnología <br />blockchain.</span>,
    },
    {
        id: 3,
...
const customBeneficiosDos: CustomBeneficiosDos[] = [
    ...
    },
    {
        ...
        textoDos: <span>Administración y distribución de <br />activos sin barreras geográficas.</span>,
    },
    {
        id: 3,
        ...
        <Box>
            ...
            <Box sx={{
                ...
                <Box sx={{
                    ...
                    {customBeneficios.map(({iconoBeneficios, textAlt, titulo, texto}, id) => (
                        <Box key={id} sx={{
                            display: 'flex',
                            alignItems: 'center',
                ...
                <Box sx={{
                    ...
                    {customBeneficiosDos.map(({iconoBeneficiosDos, textAltDos, tituloDos, textoDos}, id) => (
                        <Box key={id} sx={{
                            display: 'flex',
                            alignItems: 'center',
                            justifyContent: 'start',
