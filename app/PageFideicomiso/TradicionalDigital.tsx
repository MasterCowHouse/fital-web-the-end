...
const customFideicomiso: CustomFideicomiso[] = [
  {
    ...
    textoUno: (
      <span>
        Tradicional: Requiere papeleo y <br /> trámites legales presenciales.
      </span>
    ),
    ...
    textoDos: (
      <span>
        Digital: Se gestiona en línea de forma <br />
        rápida y sencilla.
      </span>
    ),
  },
  {
    ...
    textoDos: (
      <span>
        Digital: Automatizada y más eficiente, <br />
  ...
  },
  {
    ...
    textoUno: (
      <span>
        Tradicional: Depende de reportes y la <br />
        información no es accesible en tiempo <br />
        real.
      </span>
    ),
    ...
    textoDos: (
      <span>
        Digital: Transparente y seguro gracias a <br />
        Blockchain, con acceso en tiempo real.
      </span>
    ),
  },
  {
    ...
    textoUno: (
      <span>
        Tradicional: Cambios complicados y <br />
        requieren nuevos trámites.
      </span>
    ),
    ...
    textoDos: (
      <span>
        Digital: Más flexible y modificaciones al <br />
        instante.
      </span>
    ),
  },
  {
    ...
    textoUno: (
      <span>
        Tradicional: Más caro por los <br />
        intermediarios y trámites.
      </span>
    ),
    ...
    textoDos: (
      <span>
        Digital: Menos costoso, al eliminar <br />
        intermediarios.
      </span>
    ),
  },
